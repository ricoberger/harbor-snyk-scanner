...
func TestGetFields(t *testing.T) {
	...
	fields = getFields(ctx1, zap.String("foo", "bar"))
	require.Equal(t, []zap.Field{zap.String("foo", "bar"), zap.String("requestID", "requestID")}, fields)

	ctx2 := ContextWithValue(ctx1, zap.String("hello", "world"))
	fields = getFields(ctx2, zap.String("foo", "bar"))
	require.Equal(t, []zap.Field{zap.String("foo", "bar"), zap.String("requestID", "requestID"), zap.String("hello", "world")}, fields)
}
